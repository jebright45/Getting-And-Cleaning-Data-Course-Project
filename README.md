...
splitactivitydataset4 <- split(activitydataset4, interaction(activitydataset4$activitycode, activitydataset4$subjectid), drop = TRUE) 
# Makes it so that we have...
activitydataset5 <- sapply(splitactivitydataset4, function(x) colMeans(x[ ,3:81]))                                                    
# the 180 combos of levels...
View(activitydataset5)                                                                                                                
# that I mentioned above.
dim(activitydataset5)                                                                                                                 
# Then split by those levels.
